...
const ProblemSolved = () => {
  return (
    <>
              ...
              <div>
                <div className='flex items-start gap-2 w-full'>
                  ...
                  <div className='w-full max-w-xl space-y-1.5'>
                    ...
                    <p className='text-gray-100 text-md md:text-lg leading-relaxed'>Anda membutuhkan seragam yang siap digunakan untuk acara penting, namun proses produksi dan pengirimannya sering kali melewati tenggat yang telah ditentukan.</p>
                  </div>
                </div>
              </div>
              <div>
                <div className='flex items-start gap-2 w-full'>
                  ...
                  <div className='w-full max-w-xl space-y-1.5'>
                    ...
                    <p className='text-gray-100 text-md md:text-lg leading-relaxed'>Seragam yang diterima tidak selalu sesuai dengan standar yang diharapkan—baik dari segi bahan, jahitan, maupun hasil akhir.</p>
                  </div>
                </div>
              </div>
              <div>
                <div className='flex items-start gap-2 w-full'>
                  ...
                  <div className='w-full max-w-xl space-y-1.5'>
                    ...
                    <p className='text-gray-100 text-md md:text-lg leading-relaxed'>Desain seragam belum mampu merefleksikan identitas, visi, atau nilai dari perusahaan Anda secara optimal.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className='bg-gray-50 w-full py-14'>
